...
public interface ISampler<T> {
     ...
     *                                              is not a valid.
     */
    Set<Map<IConfigurable, Boolean>> sampleValidConfigurations(T model)
     ...
     *                                              is not a valid.
     */
    Set<Map<IConfigurable, Boolean>> sampleInvalidConfigurations(T model)
        throws NotSupportedVariabilityTypeException;
     ...
     *                                              is not a valid.
     */
    boolean verifySampleAs(T model, Map<IConfigurable, Boolean> sample)
        throws NotSupportedVariabilityTypeException;
}
