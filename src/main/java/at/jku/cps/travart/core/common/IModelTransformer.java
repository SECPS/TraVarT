...
public interface IModelTransformer<I> {
	...
	FeatureModel transform(I model, String modelName, STRATEGY level) throws NotSupportedVariabilityTypeException;
	...
	default FeatureModel transform(final I model) throws NotSupportedVariabilityTypeException {
		return this.transform(model, DefaultModelTransformationProperties.ARTIFICIAL_MODEL_NAME, STRATEGY.ONE_WAY);
	}

	I transform(FeatureModel model, String modelName, STRATEGY level) throws NotSupportedVariabilityTypeException;
